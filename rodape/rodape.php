    <footer class="rodape">
        ...
        <div class="div4">
            <ul class="ul-rod"  type="none">
                <h2>Contato</h2>
                <li style="list-style: none;">
                    <a href="#" class="ancor">+55 98664-2499</a><br>
                    <a href="#" class="ancor">+55 99324-2598</a><br>
                    <a href="#" class="ancor">gregori@gmail.com</a><br>
                    <a href="#" class="ancor">ryan88@gmail.com</a><br>
