        ...
        <div class="content-empresa">
            <div class="empresa">
                ...
                <div class="content-btn-delete">
                    <a href=<?="desativar_empresa.php?id={$empresas['idUsuarios']}"?> class="btn-delete" class="btn-update" onclick="return confirm('Tem certeza que deseja desativar a empresa?')">Desativar</a>
                </div>
