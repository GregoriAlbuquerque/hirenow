...
<body>
    ...
    <div class="content-vagas-ativadas">
        <a href="../candidatos_gerenciamento/estrutura_gerenciamento_candidato.php" class="vagas-ativadas">Visualizar Candidatos Ativos</a>
    </div>
    <?php
        include 'candidatos_desativados.php';
