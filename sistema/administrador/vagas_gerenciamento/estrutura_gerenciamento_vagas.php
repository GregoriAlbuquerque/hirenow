...
<body>
    <?php
        ...
        if (isset($_GET['submit_clean'])) {
            ...
            header("Location: estrutura_gerenciamento_vagas.php");
            exit;
        }
    ...
    <div style="width: 100vw; display: flex; justjustify-content: space-around; margin: 0 15px;">
        <?php
            include '../../filtro_vagas/filtro_vagas.php';
        ?>
        <div class="vagas">
            ...
            <div class="content-vaga">
                <div class="vaga">
                    ...
                    <div class="content-btn-delete">
                        <a href=<?="desativar_vaga.php?id={$vagas['idVagas']}"?> class="btn-delete" class="btn-update" onclick="return confirm('Tem certeza que deseja desativar a vaga?')">Desativar</a>
                    </div>
