...
<head>
    ...
    <link rel="stylesheet" href="vagas_desativadas.css">
...
<body>
    ...
    ?>
        <div class="content-vagas-ativadas">
            <a href="../vagas_gerenciamento/estrutura_gerenciamento_vagas.php" class="vagas-ativadas">Visualizar Vagas Ativas</a>
        </div>
    <?php
        include 'vagas_desativadas.php';
