        ...
        <div class="content-candidato">
            <div class="candidato">
                ...
                <div class="content-btn-delete">
                    <a href=<?="desativar_candidato.php?id={$candidato['idUsuarios']}"?> class="btn-delete" class="btn-update" onclick="return confirm('Tem certeza que deseja desativar o candidato?')">Desativar</a>
                </div>
