...
<head>
    ...
    <link rel="stylesheet" href="retivar_proposta.css">
...
<body>
    ...
    <div class="content-propostas-desativadas">
        <a href="../propostas_enviadas/estrutura_propostas_enviadas.php" class="propostas-desativadas">Visualizar Propostas Ativas</a>
    </div>
    <?php
        include 'propostas_desativadas.php';
