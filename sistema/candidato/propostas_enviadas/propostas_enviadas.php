<?php
    ...
    ON interessados.id_vaga = idVagas WHERE id_candidato = $id_candidato and status_vaga = 0 and status_interesse = 0";
    ...
    <div class="content-vaga">
        <div class="vaga">
            ...
            <div class="contetnt-btn-vaga">
                <a href=<?="desativar_proposta.php?id={$vagas['idVagas']}"?> class="btn-proposta" onclick="return confirm('Tem certeza que deseja desativar a proposta?')">Desativar proposta</a>
            </div>
